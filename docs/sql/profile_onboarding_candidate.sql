-- NOT APPLIED. Connected MCP denied project access on 2026-09-08.
-- Target: klyjzbisgycegkkacbjw ONLY. Audit live columns, grants, indexes,
-- triggers, existing collisions and onboarding flags before applying as a migration.
-- Reuses tbl_users; no identity, Partner or social-data changes.
-- Existing 20260902183000 migration grandfathered established users. Do not
-- blanket-update false flags now: genuinely new users must remain incomplete.
